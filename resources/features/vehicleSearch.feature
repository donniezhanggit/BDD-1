Feature: As a user, I am able to check if a vehicle exists
  ...
  Scenario: An error message is displayed if an invalid character is keyed
    Given I have launched the vehicle search website
  ...
  Scenario: When I enter a valid registration, then the correct vehicle information is displayed
    Given I have launched the vehicle search website
